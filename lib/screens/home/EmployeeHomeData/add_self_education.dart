...
import 'package:welfare_claims_app/dialogs/education_level_dialog_model.dart';
import 'package:welfare_claims_app/dialogs/education_nature_dialog_model.dart';
import 'package:welfare_claims_app/dialogs/living_dialog_model.dart';
import 'package:welfare_claims_app/dialogs/schools_dialog_model.dart';
...
class AddSelfEducation extends StatefulWidget {
  @override
  _AddSelfEducationState createState() => _AddSelfEducationState();
}
...
class _AddSelfEducationState extends State<AddSelfEducation> {
  ...
  String selectedNature= Strings.instance.selectEducationType, selectedLevel= Strings.instance.selectLevel,
        ...
        selectedLiving= Strings.instance.selectedLiving, selectedSchool= Strings.instance.selectedSchool, selectMessOffering="Yes", selectedTransportUse="Yes";
              ...
              if(selectedStartedDate != Strings.instance.selectedStartedDate){
                if(selectedEndedDate != Strings.instance.selectedEndedDate){
                  if(selectedStartedDate != selectedEndedDate) {
                      ...
                      if (resultCardFilePath.isNotEmpty) {
                        if (studentCardFilePath.isNotEmpty) {
                          if (affiliateFilePath.isNotEmpty) {
                            ...
                            uiUpdates.ShowToast(
                                Strings.instance.selectAffiliate);
                          }
                        } else {
                          uiUpdates.ShowToast(
                              Strings.instance.selectStudentCard);
                        }
                      } else {
                    ...
                    uiUpdates.ShowToast(Strings.instance.dateNotSame);
                  }
                }else{
