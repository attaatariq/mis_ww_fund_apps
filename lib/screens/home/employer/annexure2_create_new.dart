...
class Annex3ANew extends StatefulWidget {
  @override
  _Annex3ANewState createState() => _Annex3ANewState();
}
...
class _Annex3ANewState extends State<Annex3ANew> {
...
*/
                            ...
                            if (investedByCoController.text.isNotEmpty) {
                              if (amountDistributed1CategoryController
                                ...
                                if (amountDistributed2CategoryController
                                    .text.isNotEmpty) {
                                    if (amountPaidCompanyController
                                        .text.isNotEmpty) {
                                        if (investedByBOTController
                                            .text.isNotEmpty) {
                                      ...
                                      uiUpdates.ShowToast(Strings
                                          .instance.amountPaidCompanyNotEmpty);
                                    }
                                } else {
                              ...
                              uiUpdates.ShowToast(
                                  Strings.instance.investedByCONotEmpty);
                            }
                          } else {
                            uiUpdates.ShowToast(
                                Strings.instance.totaInterstNotEmpty);
                          }
                        } else {
                          uiUpdates.ShowToast(
                              Strings.instance.amountEarnedPaidBOTNotEmpty);
                        }
                      } else {
                        uiUpdates.ShowToast(
  ...
  void AddAnnexA() async {
    ...
    var url = constants.getApiBaseURL() + constants.companies + "annexure_2";
...
//    request.fields['bank'] = selectBankName;//
    ...
    request.fields['intbybot'] = amountEarnedBotController.text.toString(); //
    request.fields['interest'] = totalInterstController.text.toString(); //
    request.fields['invbyco'] = investedByCoController.text.toString(); //
    request.fields['invbybot'] = investedByBOTController.text.toString(); //
    request.fields['bycompany'] = amountPaidCompanyController.text.toString(); //
