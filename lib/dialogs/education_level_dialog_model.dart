...
class EducationLevelDialogModel extends StatefulWidget {
  List<String> list;

  EducationLevelDialogModel(this.list);

  @override
  _EducationLevelDialogModelState createState() => _EducationLevelDialogModelState();
}

class _EducationLevelDialogModelState extends State<EducationLevelDialogModel> {
  @override
