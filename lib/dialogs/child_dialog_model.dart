...
class ChildDialogModel extends StatefulWidget {
  List<ChildModel> list;

  ChildDialogModel(this.list);

  @override
  _ChildDialogModelState createState() => _ChildDialogModelState();
}

class _ChildDialogModelState extends State<ChildDialogModel> {
  @override
