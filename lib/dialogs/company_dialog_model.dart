...
class CompaniesDialogModel extends StatefulWidget {
  ...
  CompaniesDialogModel(this.list);

  @override
  _CompaniesDialogModelState createState() => _CompaniesDialogModelState();
}

class _CompaniesDialogModelState extends State<CompaniesDialogModel> {
  @override
