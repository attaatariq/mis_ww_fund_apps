...
class SchoolsDialogModel extends StatefulWidget {
  List<SchoolModel> list;

  SchoolsDialogModel(this.list);

  @override
  _SchoolsDialogModelState createState() => _SchoolsDialogModelState();
}

class _SchoolsDialogModelState extends State<SchoolsDialogModel> {
  @override
