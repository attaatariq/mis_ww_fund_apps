...
class ProvinceDialogModel extends StatefulWidget {
  List<ProvinceModel> list;

  ProvinceDialogModel(this.list);

  @override
  _ProvinceDialogModelState createState() => _ProvinceDialogModelState();
}

class _ProvinceDialogModelState extends State<ProvinceDialogModel> {
  @override
                          ...
                          itemBuilder: (_, int index) =>
                              GestureDetector(
                                onTap: (){
                                  ...
                                  child: CenterTextListItem(widget.list[index].provinceName)),
