...
class ComplaintTypeDialogModel extends StatefulWidget {
  ...
  ComplaintTypeDialogModel(this.list);

  @override
  _ComplaintTypeDialogModelState createState() => _ComplaintTypeDialogModelState();
}

class _ComplaintTypeDialogModelState extends State<ComplaintTypeDialogModel> {
  @override
