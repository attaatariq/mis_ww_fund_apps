...
class YearsDialogModel extends StatefulWidget {
  List<String> list;

  YearsDialogModel(this.list);

  @override
  _YearsDialogModelState createState() => _YearsDialogModelState();
}

class _YearsDialogModelState extends State<YearsDialogModel> {
  @override
